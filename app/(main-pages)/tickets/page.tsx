...
const initialTickets: Ticket[] = [
  {
    ...
    description: 'Production email server down since 9 AM',
    status: 'open',
    priority: 'urgent',
    assignee: 'Mike Chen',
  ...
  {
    id: 'T-1031',
    title: 'New laptop setup for Marketing',
    description: 'Need 3 laptops configured for new hires',
    status: 'in_progress',
    priority: 'medium',
    assignee: 'Alex Kim',
  ...
  {
    id: 'T-1030',
    title: 'VPN access for remote team',
    description: 'Configure VPN access for 5 remote developers',
    status: 'in_progress',
    priority: 'high',
    assignee: 'Mike Chen',
  ...
  },
  {
    ...
    description: 'Dell monitor showing no signal',
    status: 'open',
    priority: 'low',
    assignee: 'Unassigned',
    reporter: 'j.smith@company.com',
    created: '6h ago',
    updated: '6h ago',
    category: 'Hardware',
  },
  {
    ...
    description: 'Adobe Creative Suite licenses expiring next week',
    status: 'open',
    priority: 'high',
    assignee: 'Alex Kim',
  ...
  },
  {
    ...
    description: 'HP LaserJet keeps jamming',
    status: 'resolved',
    priority: 'low',
    assignee: 'Jess Park',
    reporter: 'm.doe@company.com',
    created: '1d ago',
    updated: '8h ago',
    category: 'Hardware',
  },
  {
    ...
    description: 'Nightly backup job failed with timeout error',
    status: 'resolved',
    priority: 'urgent',
    assignee: 'Mike Chen',
  ...
  },
  {
    ...
    description: 'Switch in Server Room B showing intermittent failures',
    status: 'in_progress',
    priority: 'high',
    assignee: 'Jess Park',
  ...
  {
    id: 'T-1023',
    title: 'Install antivirus on new machines',
    description: '10 new workstations need endpoint protection',
    status: 'closed',
    priority: 'medium',
    assignee: 'Jess Park',
    reporter: 'IT Manager',
...
> = {
  low: {
    label: 'Low',
    className:
      'bg-slate-100 text-slate-600 dark:bg-slate-500/15 dark:text-slate-400 border border-slate-200 dark:border-slate-700',
    dotColor: 'bg-slate-400',
  },
  medium: {
    label: 'Medium',
  ...
  high: {
    label: 'High',
    className:
      'bg-orange-50 text-orange-700 dark:bg-orange-500/15 dark:text-orange-400 border border-orange-200 dark:border-orange-800',
    dotColor: 'bg-orange-500',
  },
  urgent: {
    label: 'Urgent',
    className:
      'bg-red-50 text-red-700 dark:bg-red-500/15 dark:text-red-400 border border-red-200 dark:border-red-800',
    dotColor: 'bg-red-500',
  },
}
    ...
    >
      ...
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex items-center gap-1.5">
          <span
            className={`inline-flex items-center gap-1.5 text-[10px] leading-none font-semibold px-1.5 py-1 rounded ${priority.className}`}
          >
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
          ...
          <div ref={filterRef} className="relative" id="assignee-filter">
            ...
            >
              ...
              <ChevronDown
                className={`h-3.5 w-3.5 shrink-0 text-slate-400 transition-transform duration-200 ${filterOpen ? 'rotate-180' : ''}`}
              />
            </button>
