...
const mockAssets: Asset[] = [
  { id: "A-001", name: 'MacBook Pro 16"', type: "laptop", serialNumber: "SN-MBP-2024-001", status: "assigned", assignedTo: "Sarah Wilson", location: "Floor 2", purchaseDate: "Jan 2024", warrantyExpiry: "Jan 2027", value: "$2,499" },
  { id: "A-002", name: 'Dell UltraSharp 27"', type: "monitor", serialNumber: "SN-DEL-2024-002", status: "assigned", assignedTo: "Mike Chen", location: "Floor 3", purchaseDate: "Feb 2024", warrantyExpiry: "Feb 2027", value: "$649" },
  { id: "A-003", name: "iPhone 15 Pro", type: "phone", serialNumber: "SN-IPH-2024-003", status: "assigned", assignedTo: "Admin User", location: "Floor 1", purchaseDate: "Mar 2024", warrantyExpiry: "Mar 2026", value: "$999" },
  { id: "A-004", name: "Dell PowerEdge R750", type: "server", serialNumber: "SN-SRV-2023-004", status: "maintenance", assignedTo: null, location: "Server Room A", purchaseDate: "Jun 2023", warrantyExpiry: "Jun 2028", value: "$8,500" },
  { id: "A-005", name: "HP LaserJet Pro", type: "printer", serialNumber: "SN-PRT-2024-005", status: "available", assignedTo: null, location: "Floor 3", purchaseDate: "Apr 2024", warrantyExpiry: "Apr 2026", value: "$399" },
  { id: "A-006", name: "Cisco Catalyst 9300", type: "network", serialNumber: "SN-NET-2023-006", status: "assigned", assignedTo: "IT Infrastructure", location: "Server Room B", purchaseDate: "Aug 2023", warrantyExpiry: "Aug 2028", value: "$4,200" },
  { id: "A-007", name: "ThinkPad X1 Carbon", type: "laptop", serialNumber: "SN-LEN-2024-007", status: "available", assignedTo: null, location: "IT Storage", purchaseDate: "Mar 2024", warrantyExpiry: "Mar 2027", value: "$1,899" },
  { id: "A-008", name: 'LG 34" Ultrawide', type: "monitor", serialNumber: "SN-LG-2024-008", status: "assigned", assignedTo: "Jess Park", location: "Floor 2", purchaseDate: "Feb 2024", warrantyExpiry: "Feb 2027", value: "$899" },
  { id: "A-009", name: "Dell OptiPlex 7010", type: "laptop", serialNumber: "SN-OPT-2023-009", status: "retired", assignedTo: null, location: "IT Storage", purchaseDate: "Jan 2021", warrantyExpiry: "Jan 2024", value: "$1,200" },
  { id: "A-010", name: "Ubiquiti Dream Machine", type: "network", serialNumber: "SN-UBI-2024-010", status: "assigned", assignedTo: "IT Infrastructure", location: "Floor 1", purchaseDate: "May 2024", warrantyExpiry: "May 2026", value: "$379" },
  { id: "A-011", name: "Samsung Galaxy S24", type: "phone", serialNumber: "SN-SAM-2024-011", status: "available", assignedTo: null, location: "IT Storage", purchaseDate: "Apr 2024", warrantyExpiry: "Apr 2026", value: "$799" },
  { id: "A-012", name: "Logitech MX Master Bundle", type: "peripheral", serialNumber: "SN-LOG-2024-012", status: "assigned", assignedTo: "Alex Kim", location: "Floor 3", purchaseDate: "May 2024", warrantyExpiry: "May 2026", value: "$199" },
];
...
const statusConfig: Record<AssetStatus, { label: string; className: string }> = {
  available: { label: "Available", className: "bg-emerald-100/80 text-emerald-700 dark:bg-emerald-500/10 dark:text-emerald-400" },
  assigned: { label: "Assigned", className: "bg-blue-100/80 text-blue-700 dark:bg-blue-500/10 dark:text-blue-400" },
  maintenance: { label: "Maintenance", className: "bg-amber-100/80 text-amber-700 dark:bg-amber-500/10 dark:text-amber-400" },
    ...
    <div className="flex-1 space-y-6 p-4 sm:p-6 md:p-8 pt-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-4">
        {[
          ...
          { label: "Available", value: statusCounts.available, color: "text-emerald-600 dark:text-emerald-400" },
          { label: "Assigned", value: statusCounts.assigned, color: "text-blue-600 dark:text-blue-400" },
          { label: "Maintenance", value: statusCounts.maintenance, color: "text-amber-600 dark:text-amber-400" },
      ...
      {view === "table" ? (
              ...
              return (
                ...
                >
                  <div className="flex items-center">
                    <span className="text-sm font-mono font-semibold text-red-600 dark:text-red-400">{asset.id}</span>
                  </div>
                  ...
                  <div className="flex items-center gap-1.5">
                    {asset.assignedTo ? (
                      <>
                        ...
                        <span className="text-sm text-slate-600 dark:text-slate-300 truncate">{asset.assignedTo}</span>
                      </>
                    ) : (
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-xs text-slate-500 dark:text-slate-400 truncate">{asset.location}</span>
                  </div>
                  <div className="flex items-center">
                    <span className="text-sm font-semibold text-slate-700 dark:text-slate-200">{asset.value}</span>
                  </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {filtered.map((asset) => {
            ...
            const status = statusConfig[asset.status];
            return (
              <div key={asset.id} className="rounded-2xl border bg-white dark:bg-zinc-900 shadow-sm ring-1 ring-slate-200/50 dark:ring-white/10 p-5 hover:shadow-md hover:-translate-y-0.5 transition-all cursor-pointer group">
                ...
                <p className="text-xs text-red-600 dark:text-red-400 font-mono font-semibold mb-3">{asset.id}</p>
                <div className="space-y-2 text-xs text-slate-500 dark:text-slate-400">
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-slate-100 dark:border-white/5">
                    <span className="font-semibold text-slate-700 dark:text-slate-200">{asset.value}</span>
      ...
      <div className="flex items-center justify-between text-sm text-slate-500 dark:text-slate-400">
        <span>Showing {filtered.length} of {mockAssets.length} assets</span>
        <div className="flex items-center gap-2">
